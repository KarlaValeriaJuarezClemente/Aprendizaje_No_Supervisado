...
class KMeansOptimizer:
    ...
    def visualizar_resultados(self, datos_escalados: np.ndarray, etiquetas: np.ndarray,
        ...
        plt.tight_layout()
        plt.savefig('ANS/KMeans_Analisis_Completo.png', dpi=300, bbox_inches='tight')
        plt.close()
        ...
        try:
            ...
            plt.tight_layout()
            plt.savefig('ANS/Cluster_Caracteristicas.png', dpi=300, bbox_inches='tight')
            plt.close()
            
            # Guardar datos del heatmap
            promedios_cluster.T.to_csv('ANS/Cluster_Caracteristicas_Data.csv')
    ...
    def guardar_resultados(self):
        try:
            ...
            resultados_df.to_csv('ANS/KMeans_Resultados.csv', index=False)

            # Guardar parametros y distribucion detallada
            with open('ANS/KMeans_Resumen_Detallado.txt', 'w') as f:
            ...
            print("Resultados guardados en carpeta KPIs/")
...
if resultados_kmeans:
    ...
    estadisticas_clusters.to_csv('ANS/Estadisticas_Clusters_Detalladas.csv')
    
    print("\n" + "-"*33)
    print("ANALISIS COMPLETADO EXITOSAMENTE")
    print("-"*33)
    print("ARCHIVOS GENERADOS:")
    print("  - ANS/KMeans_Analisis_Completo.png")
    print("  - ANS/Cluster_Caracteristicas.png")
    print("  - ANS/KMeans_Resultados.csv")
    print("  - ANS/KMeans_Resumen_Detallado.txt")
    print("  - ANS/Estadisticas_Clusters_Detalladas.csv")
...
if bandwidth == 0:
    ...
    plt.savefig('ANS/MeanShift_Clustering.png', dpi=300, bbox_inches='tight')
    plt.close() 
...
if df_clustering_clean.shape[0] < 2:
    ...
    try:
        ...
        plt.tight_layout()
        plt.savefig('ANS/Hierarchical_Clustering.png', dpi=300, bbox_inches='tight')
        plt.close() 
        print("\nDendrograma generado exitosamente. Puedes usarlo para decidir el número de clústeres.")      
